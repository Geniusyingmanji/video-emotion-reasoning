...
help:
	...
	@echo "  synth-eval     Stage 7 evaluation for all E0/E1/E2/E3 on synthetic (GPT-5.5)"
	@echo "  synth-eval-qwen Stage 7 on synthetic with Qwen-Omni (E0 audio-aware, E1 text)"
